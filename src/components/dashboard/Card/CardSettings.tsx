            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-[#F1F5F9] dark:bg-black  border-0">
                <div className="rounded-t bg-gray-50 dark:bg-black mb-0 px-6 py-6">
                    <div className="text-center flex justify-between">
                        ...
                        <button
                            className="bg-blueGray-700 active:bg-blueGray-600 text-black dark:text-white font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
                            type="button"
                            onClick={e => {
                                e.preventDefault();
                                setHide(false);
