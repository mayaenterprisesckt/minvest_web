            ...
            <main className="profile-page">
                ...
                <section className="relative py-16 bg-blueGray-200">
                    <div className="container mx-auto px-4">
                        <div className="relative flex flex-col min-w-0 break-words bg-white dark:bg-primaryDark w-full mb-6 shadow-xl rounded-lg -mt-64">
                            <div className="px-6">
...
DistributerProfile.PageLayout = DisGuard;

// export const getServerSideProps: GetServerSideProps = async context => {
//     const id = context.query.id;

//     const res = await fetch(`https://fakestoreapi.com/products/${id}`);
//     const distributer: User.User = await res.json();
